...
print(f"Сотрудники, которые работали в разных сменах: {employee_shift}")
print(f"Смены, где отработали меньше 8 часов: {shift_hours}")
print(f"Сотрудники, отработавшие больше 12 часов: {employee_hours}")
